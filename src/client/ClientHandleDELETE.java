...
public class ClientHandleDELETE extends ClientHandleRequest{
    ...
    public String[] operation(String[] request) {
        ...
        try {
            ...
            String outputTerminal = "Delete failed: Communication between client and server failed. Please check the network or contact the Server's administrator.";
            return createResponse(flag, outputContent, outputTerminal);
            ...
            String flag = "FAIL";
            String outputContent = "";
            String outputTerminal = "Delete failed: Can not connect the server. Please check the network, server address, server port number or contact the developer.";
            return createResponse(flag, outputContent, outputTerminal);
        }
    }
}
