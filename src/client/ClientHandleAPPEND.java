...
public class ClientHandleAPPEND extends ClientHandleRequest{
    ...
    public String[] operation(String[] request){
        ...
        try {
            ...
            String outputTerminal = "Append failed: Communication between client and server failed. Please contact the developer.";
            return createResponse(flag, outputContent, outputTerminal);
            ...
            String flag = "FAIL";
            String outputContent = "";
            String outputTerminal = "Append failed: Can not connect the server. Please check the network or contact the developer.";
            return createResponse(flag, outputContent, outputTerminal);
        }
    }
}
